...
import de.htwg.se.WinDetectorComponent.WinDetectorComponent_Impl.WinStub
import WinDetectorComponent.WinDetectorInterface
import de.htwg.se.fieldComponent.fieldBaseImpl.Stone
import scala.languageFeature.postfixOps
import scala.util.{Try, Success, Failure}

case class mediumStrategy() extends ComputerStrategy {
  var plannedNext = (0, 0)
