...
lazy val root = project
  ...
  .settings(
    ...
    libraryDependencies += ("org.scala-lang.modules" %% "scala-xml" % "1.1.1").cross(CrossVersion.for3Use2_13),
    libraryDependencies += ("com.typesafe.play" %% "play-json" % "2.6.6").cross(CrossVersion.for3Use2_13), 
